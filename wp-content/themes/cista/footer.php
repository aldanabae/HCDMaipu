			...
			<div class="enigma_footer_social_div">
				<ul class="social">
					<?php if($wl_theme_options['fb_link']!='') { ?>
					   <li class="facebook" data-toggle="tooltip" data-placement="top" title="Facebook"><a  href="https://www.facebook.com/hcd.maipu.5"><i class="fa fa-facebook"></i></a></li>
...
<a href="#" title=<?php _e('Go Top','cista');?> class="enigma_scrollup" style="display: inline;"><i class="fa fa-chevron-up"></i></a>
