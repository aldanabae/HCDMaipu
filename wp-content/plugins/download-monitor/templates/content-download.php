...
?>
<a class="download-link" style="font-size: 18px;" title="<?php if ( $dlm_download->has_version_number() ) {
...
</a> <!--Cambio tamaño de letra para que se vean mejor los links style="font-size: 18px;"-->