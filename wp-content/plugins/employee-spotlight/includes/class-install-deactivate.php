		...
		private function set_options() {
			...
			$ent_list = Array(
				'emd_employee' => Array(
					...
					'req_blt' => Array(
						'blt_title' => Array(
							'msg' => __('Title', 'employee-spotlight')
						) ,
					) ,
				) ,
			);
			...
			$glob_list['glb_imgborder_color'] = Array(
				...
				'type' => 'text',
				'desc' => 'Sets the color of image border. If you put in "none" (without quotes), it will not display border.',
				'values' => '',
				'dflt' => '#4abaae',
				'required' => 0,
				'shc_list' => Array(
...
<div class="updated">
<?php
				printf('<p><a href="%1s" target="_blank"> %2$s </a>%3$s<a style="float:right;" href="%4$s"><span class="dashicons dashicons-dismiss" style="font-size:15px;"></span>%5$s</a></p>', 'https://emdplugins.com/plugin_tag/empslight-com?pk_campaign=empslight-com&pk_source=plugin&pk_medium=link&pk_content=notice', __('Extend or Upgrade Employee Spotlight Now!', 'wpas') , __('&#187;', 'wpas') , esc_url(add_query_arg($this->option_name . '_adm_notice2', true)) , __('Dismiss', 'wpas'));
?>
</div>
<?php
			}
