...
function employee_spotlight_frontend_scripts() {
	...
	if (is_tax('office_locations')) {
		...
		employee_spotlight_enq_custom_css();
		return;
	}
	if (is_tax('groups')) {
		wp_enqueue_style('frontgen');
 ...
 *
 */
function employee_spotlight_enq_custom_css() {
...
add_action('plugins_loaded', 'employee_spotlight_print_css');
/**
