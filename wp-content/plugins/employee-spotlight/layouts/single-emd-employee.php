...
" class="person-img circle"><?php if (get_post_meta($post->ID, 'emd_employee_photo')) {
    ...
    <div class="person-detail col-md-8">
        ...
        <div class="person-link">
            <?php if (emd_is_item_visible('ent_employee_email', 'employee_spotlight', 'attribute')) { ?> <a class="social-icon email animate fa fa-envelope fa-fw" href="mailto:<?php echo esc_html(emd_mb_meta('emd_employee_email')); ?>
"></a> <?php
} ?> 
            <span class="social"> <?php if (emd_is_item_visible('ent_employee_facebook', 'employee_spotlight', 'attribute')) { ?> <a class="social-icon facebook animate fa fa-facebook fa-fw" href="<?php echo esc_html(emd_mb_meta('emd_employee_facebook')); ?>
"></a> <?php
} ?> <?php if (emd_is_item_visible('ent_employee_twitter', 'employee_spotlight', 'attribute')) { ?> <a class="social-icon twitter animate fa fa-twitter fa-fw" href="<?php echo esc_html(emd_mb_meta('emd_employee_twitter')); ?>
"></a> <?php
} ?> <?php if (emd_is_item_visible('ent_employee_github', 'employee_spotlight', 'attribute')) { ?> <a class="social-icon github animate fa fa-github-alt fa-fw" href="<?php echo esc_html(emd_mb_meta('emd_employee_github')); ?>
"></a> <?php
} ?> <?php if (emd_is_item_visible('ent_employee_google', 'employee_spotlight', 'attribute')) { ?> <a class="social-icon google-plus animate fa fa-google-plus fa-fw" href="<?php echo esc_html(emd_mb_meta('emd_employee_google')); ?>
"></a> <?php
} ?> <?php if (emd_is_item_visible('ent_employee_linkedin', 'employee_spotlight', 'attribute')) { ?> <a class="social-icon linkedin animate fa fa-linkedin fa-fw" href="<?php echo esc_html(emd_mb_meta('emd_employee_linkedin')); ?>
"></a> <?php
} ?> <?php do_action('emd_vcard', 'empslight_com', 'emd_employee', $post->ID); ?> </span>
        </div>
...
?><div id='cust-field-<?php echo $fcount; ?>'>
        <div class="cfblock"><span class="cflabel"><?php echo $rkey; ?></span> <span class="cfvalue"><?php echo $val; ?></span></div>
        </div><?php
	}
}
?> 
...
<div class="tax-block" style="padding:40px 0">
    <div class="fcontent"> <?php if (emd_is_item_visible('tax_office_locations', 'employee_spotlight', 'taxonomy')) { ?> <span class="footer-object-title badge alert-info"><?php _e('Location', 'employee-spotlight'); ?></span><span class="footer-object-value"><?php echo emd_get_tax_vals(get_the_ID() , 'office_locations'); ?></span> <?php
} ?> <?php if (emd_is_item_visible('tax_groups', 'employee_spotlight', 'taxonomy')) { ?> <span class="footer-object-title badge alert-info"><?php _e('Groups', 'employee-spotlight'); ?></span><span class="footer-object-value"><?php echo emd_get_tax_vals(get_the_ID() , 'groups'); ?></span> <?php
