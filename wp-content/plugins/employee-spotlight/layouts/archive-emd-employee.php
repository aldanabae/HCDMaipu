                ...
                <div class="srcontent">
                    ...
                    <div class="segment-block">
                        <div class="row" data-has-attrib="false">
                            <div class="col-md-6"> <span class="segtitle"><?php echo "Puesto"; ?></span> </div> <!--cambio para que aparezca Puesto no Job Title-->
...
"><?php echo esc_html(emd_mb_meta('emd_employee_email')); ?>
                    ...
                    <div class="segment-block">
                        <div class="row" data-has-attrib="false">
                            <div class="col-md-6"> <span class="segtitle"><?php _e('Location', 'employee-spotlight'); ?></span> </div>
                            <div class="col-md-6"> <span class="taxlabel"><?php echo emd_get_tax_vals(get_the_ID() , 'office_locations'); ?></span> </div>
                        </div>
                    </div>
                    <?php
} ?> 
